<?php
class ModelExtensionModuleThmsoftfeatured extends Model {
...
//echo $date_end;exit();
	...
	//public function getTotalProductsfeatured() {
		// $sql = "SELECT setting FROM " . DB_PREFIX . "module WHERE name = 'thmsoft-fetaured-products'";

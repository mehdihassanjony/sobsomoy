...
jQuery(document).ready(function() {
	...
	jQuery("#bestsell-slider .slider-items").owlCarousel({
		...
		itemsDesktopSmall: [900, 3], // 4 items betweem 900px and 899px
		itemsTablet: [768, 3], //3 items between 899 and 767;
		itemsTablet: [500, 2], //2 items between 480 and 767;
		itemsMobile: [360, 1],
		navigation: true,
	...
	jQuery("#special .slider-items").owlCarousel({
		...
		itemsTablet: [768, 2], //2 items between 480 and 767;
		itemsMobile: [360, 1],
		navigation: true,
		navigationText: ["<a class=\"flex-prev\"></a>", "<a class=\"flex-next\"></a>"],
		slideSpeed: 500,

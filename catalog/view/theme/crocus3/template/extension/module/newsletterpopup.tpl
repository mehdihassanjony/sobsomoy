...
<div class="popup1 modal fade" id="myModal" tabindex="-1" role="dialog">   
  <div class="newsletter-sign-box">  
    <div class="newsletter"> 
      ...
      <div id="formSuccess1" style="display:none;"><?php echo $text_success; ?></div>
      <div class="email-form">
      <div class="div-left">
         <!--img src="<?php //echo $newsletterpopup_bg_image; ?>"-->
         <img src="catalog/view/theme/crocus3/image/newsletter.jpg">
      </div>
      <div class="div-right">
        ...
        <div class="newsletter-form">
          <div class="input-box">
            <p id="subscriber_content_popup"></p>
               <input  type="text" name="subscriber_email_popup" id="subscriber_email_popup" value="" placeholder="<?php echo $entry_email; ?>" class="input-text required-entry validate-email" />

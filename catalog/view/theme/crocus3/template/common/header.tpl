...
.top-link-compare,.top-link-wishlist, .header-top .toplinks div.links div a{color:<?php echo "#".$thmsoftcrocus_headerlinkcolor; ?>;} <?php } ?>
<?php if($thmsoftcrocus_headerlinkhovercolor_ed==1) { ?>
.top-link-compare:hover,.top-link-wishlist:hover,.header-top .toplinks div.links div a:hover{color:<?php echo "#".$thmsoftcrocus_headerlinkhovercolor."! important" ?>;} <?php } ?>
...
<div class="mm-toggle-wrap">
  <div class="mm-toggle"><i class="fa fa-bars"></i><span class="mm-label"><?php echo $text_menu;?></span> </div>
</div>
<div class="nav-inner">
   <ul class="hidden-xs" id="nav">
    <?php if($thmsoftcrocus_home_option==1){ ?>
    <li id="nav-home" class="level0 parent drop-menu active"> <a class="level-top" href="<?php echo $home;?>"> <span><?php echo $text_home;?></span> </a>
    </li><?php }?>
    <?php foreach ($categories1 as $category) { $mclass='';  $mclass1=''; ?>
    <li  class="mega-menu">
      <a href="<?php echo $category['href']; ?>" class="level-top <?php if($category['category_id']==$cat_id) {echo 'active';}?>">

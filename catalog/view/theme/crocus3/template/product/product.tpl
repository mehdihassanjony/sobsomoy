      ...
      <div class="product-essential">     
          ...
          <div class="product-shop col-lg-8 col-sm-7 col-xs-12">
            ...
            <?php if ($review_status) { ?>
              ...
              <?php if ($price) { ?>
                ...
                <div class="price-box">
                  ...
                  <?php } ?>
                    <p class="availability <?php if($stock == "In Stock") {echo "in-stock"; } else { echo "out-of-stock"; } ?>"><span><?php echo $stock; ?></span></p>                
                  </div>
                </div>                
            ...
            <div class="add-to-box">
              ...
              <li><a class="link-wishlist" title="<?php echo $text_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');">
           ...
           <?php /* ?> <div class="addthis_toolbox addthis_default_style" data-url="<?php echo $share; ?>"><a class="addthis_button_facebook_like" fb:like:layout="button_count"></a> <a class="addthis_button_tweet"></a> <a class="addthis_button_pinterest_pinit"></a> <a class="addthis_counter addthis_pill_style"></a></div>
            <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-515eeaf54693130e"></script> <?php  */ ?>
            <!-- AddThis Button END -->

    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="buttons clearfix">
        <div class="pull-left">
          ...
          <button onclick="window.location='<?php echo $continue; ?>'" class="button btn-continue" type="button"><span><span><?php echo $button_shopping; ?></span></span></button>
        </div>
        <div class="pull-right">
          <!-- <a href="<?php //echo $checkout; ?>" class="btn btn-primary"><?php //echo $button_checkout; ?></a> -->
          <button onclick="window.location='<?php echo $checkout; ?>'" class="button btn-proceed-checkout" type="button"><span><?php echo $button_checkout; ?></span></button>
        </div>
      </div>

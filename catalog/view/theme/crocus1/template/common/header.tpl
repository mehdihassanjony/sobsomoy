...
<div class="nav-inner">
   <ul class="hidden-xs" id="nav">
    ...
    <ul class="level1">
       <li class="level2 first"><a href="http://occrocus.themessoft.com/"><span>Version 1</span></a> </li>
       <li class="level2 nav-10-2"> <a href="http://occrocus1.themessoft.com/"> <span>Version 2</span> </a> </li>
    </ul>
    </li><?php }?>

...
class ControllerExtensionModuleThmsoftbestseller extends Controller {
	public function index($setting) {
		...
		$this->load->model('extension/module/thmsoftbestseller');


		$data['products'] = array();

		$results = $this->model_extension_module_thmsoftbestseller->getBestSellerProducts($setting['limit']);
		...
		if ($results) {
			...
			return $this->load->view('extension/module/thmsoftbestseller', $data);
		}
	}
}

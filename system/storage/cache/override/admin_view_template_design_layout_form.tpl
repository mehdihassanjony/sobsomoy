...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-slider-left, #module-slider-right, #module-top-left, #module-top-right').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-slider-left, #module-slider-right, #module-top-left, #module-top-right').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>
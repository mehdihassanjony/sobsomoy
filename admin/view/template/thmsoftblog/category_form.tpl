        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
		    ...
		    <select name="parent_id" id="input-parent_id" class="form-control">
                  ...
                  <?php if ($_parentcategory['category_id'] == $parent_id) { ?>
                  <option value="<?php echo $_parentcategory['category_id']; ?>" selected="selected"><?php echo $_parentcategory['name']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo $_parentcategory['category_id']; ?>"><?php echo $_parentcategory['name']; ?></option>
                  <?php } ?>
                  <?php } ?>
                </select>
                </div>

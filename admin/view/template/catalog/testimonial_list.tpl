            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left">
                    <a href="#"><?php echo $column_image; ?></a>
                   </td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($testimonial['testimonial_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><img src="<?php echo $testimonial['image']; ?>"></td>
                  <td class="text-left"><?php echo $testimonial['author']; ?></td>
                  <td class="text-right"><?php echo $testimonial['rating']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=catalog/testimonial&token=<?php echo $token; ?>';

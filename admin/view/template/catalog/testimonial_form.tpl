      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group <?php if($bio_required_status) echo 'required';?>">
            ...
            <div class="col-sm-10">
              <input type="text" name="bio" value="<?php echo $bio; ?>" placeholder="<?php echo $entry_bio; ?>" id="input-bio" class="form-control" />
              <?php if ($error_bio) { ?>
              <div class="text-danger"><?php echo $error_bio; ?></div>
              <?php } ?>
            </div>
          </div>
          <?php } ?>
          ...
          <div class="form-group <?php if($image_required_status) echo 'required';?>">
            <label class="col-sm-2 control-label"><?php echo $entry_image; ?></label>
              ...
              <input type="hidden" name="no_image" value="" id="input-no-image" />
            </div>
          </div>
          <?php } ?>
...
<script type="text/javascript"><!--
  ...
  $(document).ready(function() {
    $(document).delegate('a[data-toggle=\'image\']', 'click', function(e) {
      ...
      $('#input-no-image').attr('value', 'no_image.png');
      });
    });
  });
  //--></script>

...
class ControllerExtensionModuleNewslettersubscription extends Controller {
    ...
    public function index() {
        ...
        $this->load->language('extension/module/newslettersubscription'); 
	...
	// Making of Breadcrumbs to be displayed on site
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/newslettersubscription', 'token=' . $this->session->data['token'], true)
        );

        $data['action'] = $this->url->link('extension/module/newslettersubscription', 'token=' . $this->session->data['token'], true);
	...
	$data['languages'] = $this->model_localisation_language->getLanguages();
	 ...
	 //create db for product queston if not exist
        ...
        $this->response->setOutput($this->load->view('extension/module/newslettersubscription', $data));
    ...
    protected function validate() {
        ...
        if (!$this->user->hasPermission('modify', 'extension/module/newslettersubscription')) {

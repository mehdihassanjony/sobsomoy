<?php
class crocus_ControllerExtensionModuleSpecial extends ControllerExtensionModuleSpecial {

public function preRender( $template_buffer, $template_name, &$data ) {
	    if (!$this->endsWith( $template_name, '/template/extension/module/special.tpl' )) {
